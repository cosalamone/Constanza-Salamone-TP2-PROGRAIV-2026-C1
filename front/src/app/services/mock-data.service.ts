...
export class MockDataService {
  ...
  private readonly _mockPublications: IPublication[] = [
    {
      ...
      comments: [
        {
          id: 'c1',
          text: '¡Qué hermoso! Yo también salí a caminar.',
          user: { name: 'Sofía', lastName: 'R.' },
          createdAt: new Date('2026-06-16T10:00:00'),
        },
        {
          id: 'c2',
          text: 'Me encanta ese barrio en esta época.',
          user: { name: 'Carlos', lastName: 'A.' },
  ...
  public getPublications(
    ...
    page: number = 1,
    limit: number = 5,
  ): { publications: IPublication[]; total: number } {
  ...
  public getCurrentUserProfile(): {
    user: User;
    stats: { publications: number; likes: number; comments: number };
  } | null {
